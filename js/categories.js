...
<h1 class="text-md  font-bold" >${category.name}</h1>
                    ...
                    <div class="text-end ">
                        <a class="text-pink-500 inline-flex items-center md:mb-2 lg:mb-0 justify-items-end">
                        <button type="submit"  >   <svg class="w-4 h-4 ml-2" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"
